  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs">Paragrafo</span>
      </DropDownItem>
      <DropDownItem
      ...
      >
        <i className="icon h1" />
        <span className="text-xs">Intestazione 1</span>
      </DropDownItem>
      <DropDownItem
      ...
      >
        <i className="icon h2" />
        <span className="text-xs">Intestazione 2</span>
      </DropDownItem>
      <DropDownItem
      ...
      >
        <i className="icon h3" />
        <span className="text-xs">Intestazione 3</span>
      </DropDownItem>
      <DropDownItem
      ...
      >
        ...
        <span className="text-xs">Elenco puntato</span>
      </DropDownItem>
      <DropDownItem
      ...
      >
        ...
        <span className="text-xs">Elenco numerato</span>
      </DropDownItem>
      <DropDownItem
      ...
      >
        ...
        <span className="text-xs">Citazione</span>
      </DropDownItem>
    </DropDown>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs">Sinistra</span>
      </DropDownItem>
      <DropDownItem
        onClick={() => {
      ...
      >
        ...
        <span className="text-xs">Destra</span>
      </DropDownItem>
      <DropDownItem
        onClick={() => {
      ...
      >
        ...
        <span className="text-xs">Giustificato</span>
      </DropDownItem>
      <DropDownItem
        onClick={() => {
        ...
        <>
          ...
          >
            ...
            >
              ...
              <span className="text-xs">Barrato</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
            ...
            >
              ...
              <span className="text-xs">Pedice</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
                activeEditor.dispatchCommand(
            ...
            >
              ...
              <span className="text-xs">Apice</span>
            </DropDownItem>
            <DropDownItem
            ...
            >
              ...
              <span className="text-xs">Resetta formattazione</span>
            </DropDownItem>
          </DropDown>
          <Divider />
          <DropDown
          ...
          >
            ...
            >
              ...
              <span className="text-xs">Disegno</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
            ...
            >
              ...
              <span className="text-xs">Columns Layout</span>
            </DropDownItem>
            ...
            >
              ...
              <span className="text-xs">Equazione</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
                editor.update(() => {
